...
<small class="text-body d-block lh-sm">{{ auth()->user()->email }}</small>
            ...
            <ul class="dropdown-menu dropdown-menu-end w-225px mt-1">
              <li class="d-flex align-items-center p-2">
                <div class="avatar avatar-sm rounded-circle d-flex align-items-center justify-content-center text-secondary"
  ...
  <svg width="32" height="32" viewBox="0 0 24 24"
    ...
    <path d="M4 20c0-4 4-6 8-6s8 2 8 6"/>
                ...
                <div class="ms-2">
                  <div class="fw-bold text-dark">{{ auth()->user()->name }}</div>
<small class="text-body d-block lh-sm">{{ auth()->user()->email }}</small>
<small class="text-body d-block lh-sm text-capitalize">Role:
